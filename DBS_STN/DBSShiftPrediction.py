...
def registerSampleData():
    ...
    SampleData.SampleDataLogic.registerCustomSampleDataSource(
        ...
        thumbnailFileName=os.path.join(iconsPath, 'coalignment_screenshot.png'),
        # Download URL and target file name
        uris="https://github.com/IVarha/SlicerDBSCoalignment/releases/download/0.0.1/left_share.mrb",
        fileNames='left_shared.mrb',
        loadFiles=True,  # This is a MRB file, so it will be loaded into the scene
        loadFileType='SceneFile',  # This is a scene file, so it will be loaded into the scene
